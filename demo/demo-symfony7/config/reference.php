 ...
 *     watch_period?: int|Param, // Period in seconds for tracking attempts (for simple single-firewall configuration) // Default: 3600
 *     firewall?: scalar|null|Param, // Firewall name where login_throttling should be applied (for simple single-firewall configuration) // Default: "main"
 *     storage?: "cache"|"database"|Param, // Storage backend for login attempts (for simple single-firewall configuration) // Default: "cache"
 *     rate_limiter?: scalar|null|Param, // Custom rate limiter service ID (for simple single-firewall configuration) // Default: null
 *     cache_pool?: scalar|null|Param, // Cache pool to use for storing the limiter state (for simple single-firewall configuration, only used when storage=cache) // Default: "cache.rate_limiter"
 *     lock_factory?: scalar|null|Param, // Lock factory service ID for rate limiter (for simple single-firewall configuration, only used when storage=cache) // Default: null
 *     firewalls?: array<string, array{ // Default: []
 ...
 *         watch_period?: int|Param, // Period in seconds for tracking attempts // Default: 3600
 *         storage?: "cache"|"database"|Param, // Storage backend for login attempts // Default: "cache"
 *         rate_limiter?: scalar|null|Param, // Custom rate limiter service ID (optional). If not provided, Symfony will use default login throttling rate limiter or database rate limiter if storage=database. Use same service ID to share rate limiter across firewalls. // Default: null
 *         cache_pool?: scalar|null|Param, // Cache pool to use for storing the limiter state (only used when storage=cache) // Default: "cache.rate_limiter"
 *         lock_factory?: scalar|null|Param, // Lock factory service ID for rate limiter (optional, only used when storage=cache) // Default: null
 *     }>,
 * }
